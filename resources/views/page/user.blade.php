            ...
            <form class="m-form m-form--fit m-form--label-align-right" action="" method="POST" id="formAdd" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group m-form__group row spkadd">
                        ...
                        <div class="col-md-6">
                            <select name="jenis_kelamin" class="form-control m-input m-select2">
                    ...
                    <div class="form-group m-form__group row spkadd">
                        ...
                        <div class="col-md-6">
                            <select name="role" class="form-control m-input m-select2">
...
<script type="text/javascript">
						...
						<div class="dropdown ' + dropup + '">\
							<a href="#" class="btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="javascript:void(0)" onclick="edit(' + row.id + ')"><i class="la la-edit"></i> Edit user</a>\
						    	<a class="dropdown-item" href="javascript:void(0)" onclick="hapus(' + row.id + ')"><i class="la la-trash-o"></i> Hapus user</a>\
    ...
    function resetForm() {
        ...
        $('[name="role"] :selected').removeAttr('selected');
        $('.m-select2').select2({
            width: '100%'
        });
    }
    ...
    function add_ajax() {
        method = 'add';
        resetForm();
        $('#exampleModalLongTitle').html("Tambah user");
